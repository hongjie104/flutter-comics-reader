...
class Global {
  ...
  //       // 登录了以后,把设备号啊,推送token啊什么的,都传给后端
  //       if (notificationToken != null && notificationToken!.isNotEmpty) {
  //         API.setNotificationToken(token: notificationToken!);
  //       }
  //       if (deviceID != null && deviceID!.isNotEmpty) {
  //         API.setDeviceID(deviceId: deviceID!);
  //       }
  //     }
  //   }
  // }

  // static bool get isLogin => _token != null && _token!.isNotEmpty;
}
